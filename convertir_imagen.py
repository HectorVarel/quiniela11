...
image_path = "C:/Users/varel/Documents/ProjectDjango/quiniela_11/podium.PNG"
...
conn = sqlite3.connect('C:/Users/varel/Documents/ProjectDjango/quiniela_11/db.sqlite3')

# Crear un cursor
cursor = conn.cursor()

# Ejecutar la actualización
cursor.execute("UPDATE principal_fotos_portada SET podium = '"+ base64_image +"';")
